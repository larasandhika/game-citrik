package  
{
	 ...
	 * @author laras
	 */
	public class stat_level1pertanyaan5 extends Entity 
	{
		...
		[Embed(source="assets gray/resize thumbnail level_1/baru 8nt.png")]
		private const _img:Class;
		private var meteran:Image = new Image (_img);
		...
		public function stat_level1pertanyaan5() 
		{
			type = "statpertanyaan";
			//x = _x,
			//y = _y;
		...
		override public function added():void 
		{
			...
			if (globalvar.stat_level1_pertanyaan5 == true)
			{
