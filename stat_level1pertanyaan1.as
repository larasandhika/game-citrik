package  
{
	 ...
	 * @author laras
	 */
	public class stat_level1pertanyaan1 extends Entity 
	{
		...
		[Embed(source="assets gray/resize thumbnail level_1/baru 9nt.png")]
		private const _img:Class;
		private var cjdw_icon:Image = new Image(_img);
		...
		public function stat_level1pertanyaan1() 
		{
			type = "statpertanyaan";
			//x = _x,
			//y = _y;
		...
		{
			if (globalvar.stat_level1_pertanyaan1 == true)
			{
