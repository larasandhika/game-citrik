package  
{
	 ...
	 * @author laras
	 */
	public class stat_level1pertanyaan7 extends Entity 
	{
		...
		[Embed(source="assets gray/resize thumbnail level_1/baru 3nt.png")]
		private const _img:Class;
		private var lampuhemat:Image = new Image (_img);
		...
		public function stat_level1pertanyaan7() 
		{
			type = "statpertanyaan";
			//x = _x,
			//y = _y;
		...
		override public function added():void 
		{
			...
			if (globalvar.stat_level1_pertanyaan7 == true)
			{
