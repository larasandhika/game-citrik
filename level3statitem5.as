package  
{
	 ...
	 * @author laras
	 */
	public class level3statitem5 extends Entity 
	{
		[Embed(source="assets gray/icon level3_small/Lampu biasa.png")]
		...
		public function level3statitem5(_x:Number, _y:Number) 
		{
			glist.add(img);
			glist.add(imgright);
