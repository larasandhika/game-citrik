package  
{
	 ...
	 * @author laras
	 */
	public class level3item5 extends Entity 
	{
		...
		public function level3item5(_x:Number, _y:Number) 
		{
			type = "item";
		...
		override public function update():void 
		{
			...
			if (countdownpause >= 90)
			{
				...
				if (globalvar.level3checkitem5 == false)
				{
				...
				if (Input.mousePressed && collidePoint(x, y, Input.mouseX, Input.mouseY) && globalvar.level3checkitem5 == false)
					{
						globalvar.snd_lev3_benar.play();
						globalvar.level3checkitem5 = true;
