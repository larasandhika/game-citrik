package  
{
	 ...
	 * @author laras
	 */
	public class stat_level1pertanyaan8 extends Entity 
	{
		...
		[Embed(source="assets gray/resize thumbnail level_1/baru 1nt.png")]
		private const _img:Class;
		private var tiang_listrik:Image = new Image(_img);
		...
		public function stat_level1pertanyaan8() 
		{
			type = "statpertanyaan";
			//x = _x,
			//y = _y;
		...
		override public function added():void 
		{
			...
			if (globalvar.stat_level1_pertanyaan8 == true)
			{
